...
_Схема: `BroadcastGoBackResponse`_
...
| Поле      | Тип       | Описание                      | Обязательное |
| --------- | --------- | ----------------------------- | ------------ |
| `success` | `boolean` | _См. подробное описание ниже_ | **Да**       |
...
_Схема: `BroadcastOnChangeVisibilityResponse`_
...
| Поле      | Тип       | Описание                      | Обязательное |
| --------- | --------- | ----------------------------- | ------------ |
| `visible` | `boolean` | _См. подробное описание ниже_ | **Да**       |
...
_Схема: `BroadcastOnServerMessageRequest`_
...
_Схема: `BroadcastOnServerMessageResponse`_
...
| `message`   | `string`  | _См. подробное описание ниже_                            | **Да**       |
...
_Схема: `ConfirmationConfirmRequest`_
...
| Поле            | Тип      | Описание                      | Обязательное |
| --------------- | -------- | ----------------------------- | ------------ |
| `operationData` | `object` | _См. подробное описание ниже_ | **Да**       |
| `endpoints`     | `object` | _См. подробное описание ниже_ | **Да**       |
...
_Схема: `ConfirmationConfirmResponse`_
...
| Поле     | Тип      | Описание                                                                                                 | Обязательное |
| -------- | -------- | -------------------------------------------------------------------------------------------------------- | ------------ |
| `status` | `string` | _См. подробное описание ниже_                                                                            | **Да**       |
...
| Поле  | Тип      | Описание                      | Обязательное |
| ----- | -------- | ----------------------------- | ------------ |
| `url` | `string` | _См. подробное описание ниже_ | **Да**       |
...
_Схема: `PdfViewerShowResponse`_
...
_Схема: `ServicesAppInfoResponse`_
...
_Схема: `ServicesBiometricsIsBiometricsEnabledResponse`_
...
_Схема: `ServicesBiometricsSetBiometricsStateRequest`_
...
_Схема: `ServicesBiometricsSetBiometricsStateResponse`_
...
_Схема: `ServicesCallerIdCheckAvailableResponse`_
...
| Поле                | Тип       | Описание                      | Обязательное |
| ------------------- | --------- | ----------------------------- | ------------ |
| `callerIdAvailable` | `boolean` | _См. подробное описание ниже_ | **Да**       |
...
_Схема: `ServicesContactsGetResponse`_
...
_Схема: `ServicesDeviceInfoGetDeviceInfoForStatisticsResponse`_
...
_Схема: `ServicesDeviceInfoGetInfoResponse`_
...
_Схема: `ServicesImagePickerFromGalleryResponse`_
...
_Схема: `LocalStorageReadRequest`_
...
_Схема: `LocalStorageReadResponse`_
...
_Схема: `LocalStorageWriteRequest`_
...
_Схема: `LocalStorageWriteResponse`_
...
_Схема: `LocationGetLocationRequest`_
...
| Поле       | Тип      | Описание                      | Обязательное |
| ---------- | -------- | ----------------------------- | ------------ |
| `accuracy` | `string` | _См. подробное описание ниже_ | Нет          |
...
_Схема: `LocationGetLocationResponse`_
...
_Схема: `ServicesPayControlCheckAvailableResponse`_
...
| Поле     | Тип       | Описание                      | Обязательное |
| -------- | --------- | ----------------------------- | ------------ |
| `result` | `boolean` | _См. подробное описание ниже_ | **Да**       |
...
_Схема: `ServicesPayControlConfirmTransactionRequest`_
...
_Схема: `ServicesPayControlConfirmTransactionResponse`_
...
_Схема: `ServicesPayControlGetUserIdResponse`_
...
_Схема: `PermissionCheckRequest`_
...
| Поле          | Тип             | Описание                      | Обязательное |
| ------------- | --------------- | ----------------------------- | ------------ |
| `permissions` | `array[string]` | _См. подробное описание ниже_ | **Да**       |
...
_Схема: `PermissionCheckResponse`_
...
_Схема: `PermissionGetResponse`_
...
_Схема: `ServicesPushIsPushEnabledResponse`_
...
_Схема: `ServicesPushSetPushStateRequest`_
...
_Схема: `ServicesPushSetPushStateResponse`_
...
_Схема: `ServicesScanQrCodeResponse`_
...
| Поле     | Тип      | Описание                      | Обязательное |
| -------- | -------- | ----------------------------- | ------------ |
| `result` | `string` | _См. подробное описание ниже_ | **Да**       |
...
_Схема: `ServicesQrScanFromFileRequest`_
...
| Поле   | Тип      | Описание                      | Обязательное |
| ------ | -------- | ----------------------------- | ------------ |
| `path` | `string` | _См. подробное описание ниже_ | Нет          |
...
_Схема: `ServicesQrScanFromFileResponse`_
...
_Схема: `SharingShareFileRequest`_
...
_Схема: `SharingShareFileResponse`_
...
_Схема: `SharingShareTextRequest`_
...
| `sharePositionOrigin` | `array[number]` | _См. подробное описание ниже_                                                    | Нет          |
...
_Схема: `SharingShareTextResponse`_
...
_Схема: `SharingShareUrlRequest`_
...
_Схема: `SharingShareUrlResponse`_
...
_Схема: `SmsConfirmationConfirmRequest`_
...
_Схема: `SmsConfirmationConfirmResponse`_
...
_Схема: `TelephoneCallResponse`_
